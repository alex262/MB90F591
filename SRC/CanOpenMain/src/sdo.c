...
#pragma section CODE=SDO, attr=CODE,locate=0xF92000
#pragma section FAR_CODE=SDO, attr=CODE,locate=0xF92000
...
/***************************************************************************/
UNS8 readNetworkDict(UNS8 bus_id, UNS8 nodeId, UNS16 index, 
		    UNS8 subindex, UNS8 *data)
{
	UNS8 res;
	UNS8 i, k;
	UNS8 line;
