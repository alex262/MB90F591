...
//#define READ_TEMP		//Читается температура
//=====ADC=======================
#define A0		PDR6_P60
#define A1		PDR6_P61
#define A2		PDR6_P62
...
//=====================================================
#define DAC_MASTER_SET_ON		PDR1_P16=1;	PDR1_P17=1;
#define DAC_MASTER_SET_OFF		PDR1_P16=0;	PDR1_P17=0;
#define DAC_STATUS_NEIGHBOUR	(PDR1&3)	//1- сосед выставил что он не мастер, 0 - сосед выставил что он мастер 
#define DAC_ADD_ADDR 			((PDR1>>2)&3)
//=====================================================
